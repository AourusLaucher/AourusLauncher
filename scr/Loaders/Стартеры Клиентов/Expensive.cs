...
namespace Loaders
{
    ...
    {
        private bool isRunning = false; // Переменная для отслеживания запуска
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Expinsive.logs");
        ...
        private class VersionInfo
        {
            ...
            public string ExecutablePath { get; set; } // Новый путь к EXE-файлу
        }
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "Expensive 3.1 1.16.5",
                Folder = "Expensive3",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Expensive3.zip",
                ExecutablePath = "Start.bat"
            },
            new VersionInfo
            {
                Name = "Expensive UPG 1.16.5",
                Folder = "ExpensiveUPD",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/ExpensiveUPD.zip",
                ExecutablePath = "Start.bat"
            },
            new VersionInfo
            {
                Name = "Expensive Visual 1.16.5",
                Folder = "ExpensiveVisual",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/ExpensiveVisual.zip",
                ExecutablePath = "Start.bat"
            },
            new VersionInfo
            {
                Name = "Expensive 2 1.16.5",
                Folder = "Expensive2",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Expensive2.zip",
                ExecutablePath = "Start.bat"
            },
           new VersionInfo
            {
                Name = "Expensive ANC 1.16.5",
                Folder = "ExpensiveANC",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/ExpensiveANC.zip",
                ExecutablePath = "Start.bat"
            }
        };
