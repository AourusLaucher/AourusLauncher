...
namespace Loaders
{
    public partial class Naruka : Form
    {
        private bool isRunning = false;
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Haruka.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "Naruka",
                Folder = "Naruka",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Naruka.zip",
