...
namespace Loaders
{
    public partial class Nursultan : Form
    {
        private bool isRunning = false; // Переменная для отслеживания запуска
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Nursultan.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                ...
                Folder = "Nurik",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Nurik.zip",
                ExecutablePath = "Start.bat"
            },
                        new VersionInfo
            {
                Name = "Nursultan 1.12.2",
                Folder = "Nurik1_12_2",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Nurik1_12_2.zip",
                ExecutablePath = "Start.bat"
            },
        };
