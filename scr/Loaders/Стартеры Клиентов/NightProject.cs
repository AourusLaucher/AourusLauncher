...
namespace Loaders
{
    public partial class NightProject : Form
    {
        private bool isRunning = false;
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "NightProject.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "NightDLC 1.7",
                Folder = "NightDLC",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/NightProject.zip",
                ExecutablePath = "Start.bat"
            },
            new VersionInfo
            {
                Name = "NightDLC Beta 0.1",
                Folder = "NightBeta",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/NightBeta.zip",
                ExecutablePath = "Start.bat"
            }
        };
