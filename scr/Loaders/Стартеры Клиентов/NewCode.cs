...
namespace Loaders
{
    public partial class NewCode : Form
    {
        ...
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "NewCode.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "NewCode build 1.0.4",
                Folder = "NewCode",
                DownloadUrl = "http://138.124.117.2:8080/CheatClients/NewCode.zip",
            ...
            new VersionInfo
            {
                Name = "NewCode Free",
                Folder = "NewCodeFree",
                DownloadUrl = "http://138.124.117.2:8080/CheatClients/NewCodeFree.zip",
                ExecutablePath = "Start.bat"
            }
        };
