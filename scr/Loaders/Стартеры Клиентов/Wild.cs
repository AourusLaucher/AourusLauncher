...
namespace Loaders
{
    public partial class Wild : Form
    {
        ...
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Wild.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "Wild 1.16.5",
                Folder = "Wild",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Wild.zip",
