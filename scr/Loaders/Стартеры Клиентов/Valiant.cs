...
namespace Loaders
{
    public partial class Valiant : Form
    {
        private bool isRunning = false;
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Valiant.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "Valiant 1.16.5",
                Folder = "Valiant",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Valiant.zip",
