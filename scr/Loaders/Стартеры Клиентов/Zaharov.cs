...
namespace Loaders
{
    public partial class Zaharov : Form
    {
        private bool isRunning = false;
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Zaharov.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "ZaharovClient 1.16.5",
                Folder = "Zaharov",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/Zaharov.zip",
        ...
        private async void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string appDataPath = Path.Combine("C:\\");
