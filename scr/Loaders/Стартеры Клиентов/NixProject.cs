...
namespace Loaders
{
    public partial class NixProject : Form
    {
        private bool isRunning = false;
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "NixProject.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "NixProject",
                Folder = "NixProject",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/NixProject.zip",
