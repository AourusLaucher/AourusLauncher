...
namespace Loaders
{
    public partial class KoshkaClient : Form
    {
        private bool isRunning = false; // Переменная для отслеживания запуска
        private readonly string logPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AourusLaucher", "Logs", "Koska.logs");
        ...
        private readonly VersionInfo[] versions = new VersionInfo[]
        {
            new VersionInfo
            {
                Name = "KoshkaClient 1.16.5",
                Folder = "KoshkaClient",
                DownloadUrl = "http://213.176.115.153:8080/CheatClients/KoshkaClient.zip",
